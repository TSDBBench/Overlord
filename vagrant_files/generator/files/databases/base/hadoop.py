...
def getDict():
    ...
    baseConfig["prerun"] = [
        "%%SSH%%sudo -s bash -c 'sed -i \"s|JAVA_HOME=\\\\${JAVA_HOME}|JAVA_HOME=$(readlink -f /usr/bin/java | sed 's:bin/java::')|g\" /home/vagrant/hadoop/etc/hadoop/hadoop-env.sh'",
        "%%SSH%%sudo -s bash -c 'sed -i \"s|<configuration>|<configuration>\\n    <property>\\n        <name>fs.defaultFS</name>\\n        <value>hdfs://%%HN0%%:54310</value>\\n    </property>\\n    <property>\\n        <name>hadoop.tmp.dir</name>\\n        <value>/home/vagrant/hadoop</value>\\n    </property>|g\" /home/vagrant/hadoop/etc/hadoop/core-site.xml'",
        "%%SSH%%sudo -s bash -c 'sed -i \"s|<configuration>|<configuration>\\n    <property>\\n        <name>dfs.replication</name>\\n        <value>5</value>\\n    </property>|g\" /home/vagrant/hadoop/etc/hadoop/hdfs-site.xml'",
    ]
    baseConfig["postrun"] = []
    baseConfig["prerun_master"] = [
        "%%SSH%%sudo -s bash -c 'echo -e \"%%HN0%%\\n%%HN1%%\\n%%HN2%%\\n%%HN3%%\\n%%HN4%%\" >> /home/vagrant/hadoop/etc/hadoop/slaves'",
        "%%SSH%%sudo -s bash -c 'echo -e \"%%HN0%%\" >> /home/vagrant/hadoop/etc/hadoop/masters'",
    ]
