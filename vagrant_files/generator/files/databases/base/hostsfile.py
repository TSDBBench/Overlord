...
def getDict():
    ...
    baseConfig["prerun"] = [
        "%%SSH%%sudo -s bash -c 'echo -e \"%%IP0%% %%HN0%%\" >> /etc/hosts'",
        "%%SSH%%sudo -s bash -c 'echo -e \"%%IP1%% %%HN1%%\" >> /etc/hosts'",
        "%%SSH%%sudo -s bash -c 'echo -e \"%%IP2%% %%HN2%%\" >> /etc/hosts'",
        "%%SSH%%sudo -s bash -c 'echo -e \"%%IP3%% %%HN3%%\" >> /etc/hosts'",
        "%%SSH%%sudo -s bash -c 'echo -e \"%%IP4%% %%HN4%%\" >> /etc/hosts'"
    ]
    baseConfig["postrun"]= []
