...
def getDict():
    dbConfig={}
    # stores on memory => no space check 
    dbConfig["db_folders"]=[]
    dbConfig["db_client"]="kdbplus"
    dbConfig["db_args"]="-p ip=%%IP%% -p port=5001"
    dbConfig["db_name"]="kdbplus_cl1_rf1"
    dbConfig["db_desc"]="kdb+ 32bit on 1 VM."
