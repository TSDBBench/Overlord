...
def getDict():
    dbConfig={}
    dbConfig["db_folders"]=["/var/lib/postgresql/9.4/main/","/var/lib/gnocchi/"]
    dbConfig["db_client"]="gnocchi"
    dbConfig["db_args"]="-p port=8041 -p cluster=gnocchi -p ip=%%IP%%"
    dbConfig["db_name"]="gnocch1"
    dbConfig["db_desc"]="gnocchi DB on 1 VM."
