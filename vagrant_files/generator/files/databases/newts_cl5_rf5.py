...
def getDict():
    ...
    dbConfig["db_name"]="newts_cl5_rf5"
    dbConfig["db_desc"]="NewTS with Cassandra together on 5 VMs with Replication Factor 5."
    ...
    dbConfig["postrun"]= []
    dbConfig["prerun_master"]= ["%%SSH%%sudo -s bash -c 'sed -i \"s|host: localhost|host: %%IP0%%|g\" /home/vagrant/newts-1.3.1/etc/config.yaml'",
