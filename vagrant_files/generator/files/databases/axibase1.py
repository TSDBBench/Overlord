...
def getDict():
    dbConfig={}
    dbConfig["db_folders"]=["/opt/atsd/hdfs-data"]
    dbConfig["db_client"]="atsd"
    dbConfig["db_args"]="-p port=8088 -p ip=%%IP%% -p username=admin -p passwd=adminadmin"
    dbConfig["db_name"]="axibase1"
    dbConfig["db_desc"]="axibase DB on 1 VM."
