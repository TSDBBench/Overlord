Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.provision "shell", privileged: false, inline: "wget -t 10 --retry-connrefused -nv \"https://s3.amazonaws.com/influxdb/influxdb_nightly_amd64.deb\""
  ...
  ############################################################
  config.vm.provision "shell", inline: "dpkg -i influxdb_nightly_amd64.deb"
  config.vm.provision "shell", privileged: false,  inline: "rm influxdb_nightly_amd64.deb"
