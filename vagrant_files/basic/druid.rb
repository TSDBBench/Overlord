Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  # Installing Druid
  config.vm.provision "shell", privileged: false, inline: "wget -t 10 --retry-connrefused -nv \"http://static.druid.io/artifacts/releases/druid-0.8.1-bin.tar.gz\""
  config.vm.provision "shell", privileged: false,  inline: "tar -xvzf druid-0.8.1-bin.tar.gz"
  config.vm.provision "shell", privileged: false,  inline: "rm druid-0.8.1-bin.tar.gz"
