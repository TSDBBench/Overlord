Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
   ...
   config.vm.provision "shell", privileged: false,  inline: "git clone https://github.com/HDFGroup/hdf5-json.git"
   config.vm.provision "shell", privileged: false,  inline: "cd hdf5-json && git checkout \"#{$git_h5json}\""
   ...
   config.vm.provision "shell", privileged: false,  inline: "git clone https://github.com/HDFGroup/h5serv.git"
   config.vm.provision "shell", privileged: false,  inline: "cd h5serv && git checkout \"#{$git_h5serv}\""
