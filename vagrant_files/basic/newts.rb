Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  # Installing NewTS
  config.vm.provision "shell", privileged: false, inline: "wget -t 10 --retry-connrefused -nv \"https://github.com/OpenNMS/newts/releases/download/1.3.1/newts-1.3.1-bin.tar.gz\""
  config.vm.provision "shell", privileged: false, inline: "tar -xvzf newts-1.3.1-bin.tar.gz"
  config.vm.provision "shell", privileged: false, inline: "rm newts-1.3.1-bin.tar.gz"
