...
def getDict():
    ...
    dbConfig["db_args"]="-p ip=\"%%IP0%%,%%IP1%%,%%IP2%%,%%IP3%%,%%IP4%%\" -p keySpacedefinitionfile=\"/home/vagrant/files/rhombus_repl5.json\""
    dbConfig["db_name"]="rhombus_cl5_rf5"
    dbConfig["db_desc"]="Rhombus with Cassandra on 5 VMs with Replication Factor 5."
