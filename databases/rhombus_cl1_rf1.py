...
def getDict():
    ...
    dbConfig["db_args"]="-p ip=%%IP%% -p keySpacedefinitionfile=\"/home/vagrant/files/rhombus_repl1.json\""
    dbConfig["db_name"]="rhombus_cl1_rf1"
    dbConfig["db_desc"]="Rhombus with Cassandra on 1 VM."
