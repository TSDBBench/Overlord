...
def getDict():
    dbConfig={}
    dbConfig["db_folders"]=["/home/vagrant"]
    dbConfig["db_client"]="basicdb"
    dbConfig["db_args"]="-p basicdb.verbose=False -p basicdb.randomizedelay=False"
    dbConfig["db_name"]="basicdb"
    dbConfig["db_desc"]="Basic DB w/o any client"
