...
def getDict():
    ...
    dbConfig["db_name"]="influxdb_cl5_rf1"
    dbConfig["db_desc"]="InfluxDB on 5 VMs with Replication Factor 1."
    ...
    dbConfig["prerun_dict"]= {
        0 : [
            ...
            "%%SSH%%sudo -s bash -c 'exit $(curl -G http://localhost:8086/query --data-urlencode \"q=ALTER RETENTION POLICY default ON testdb DURATION INF REPLICATION 1\" 2>&1 | grep -c \"error\")'",
            ]
    }
